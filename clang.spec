# This is a custom compat build of OpenCL, because it includes a compiler.
# This compiler is needed to build beignet.
...
%global clang_binaries \
	...
	%{install_bindir}/clang-func-mapping \
	%{install_bindir}/clang-import-test \
...
Release:	10%{?rc_ver:.rc%{rc_ver}}%{?dist}.1.1
...
rm -Rf %{buildroot}%{install_bindir}/{clang-refactor,clang-rename,git-clang-format,scan-build,scan-view}
...
ln -s  ../../../%{install_includedir}/clang %{buildroot}/%{pkg_includedir}/clang
ln -s  ../../../%{install_includedir}/clang-c %{buildroot}/%{pkg_includedir}/clang-c
...
%endif
%changelog
* Thu Mar 12 2019 secureworkstation - 1:7.0.1-10.1.1
- Reinclude a compiler in compat builds

* Wed Jul 24 2019 Fedora Release Engineering <releng@fedoraproject.org> - 7.0.1-10.1
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Sat Mar 30 2019 Jiri Olsa <jolsa@redhat.com> - 7.0.1-10
- Disable tools in build

* Wed Feb 20 2019 sguelton@redhat.com - 7.0.1-9
- Fix include targets

* Mon Feb 18 2019 sguelton@redhat.com - 7.0.1-8
- Fix dev package dependency

* Mon Feb 18 2019 sguelton@redhat.com - 7.0.1-7
- Sync specfile with clang7.0 package
